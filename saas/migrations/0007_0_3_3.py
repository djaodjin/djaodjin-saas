...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='charge',
            name='processor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='charges', to=settings.ORGANIZATION_MODEL),
        ),
        migrations.AlterField(
            model_name='charge',
            name='state',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='incoming', to=settings.ORGANIZATION_MODEL),
        ),
        migrations.AlterField(
            model_name='transaction',
            name='orig_organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='outgoing', to=settings.ORGANIZATION_MODEL),
        ),
    ]

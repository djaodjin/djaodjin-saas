# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-11-20 01:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='organization',
            name='extra',
            field=models.TextField(blank=True, help_text='Extra meta data (can be stringify JSON)', null=True),
        ),
        migrations.AlterField(
            model_name='organization',
            name='full_name',
        ...
        migrations.AlterField(
            model_name='organization',
            name='funds_balance',
            field=models.PositiveIntegerField(default=0, help_text='Funds escrowed in currency unit'),
        ),
        migrations.AlterField(
            model_name='organization',
            name='is_provider',
            field=models.BooleanField(default=False, help_text='The organization can fulfill the provider side of a subscription.'),
        ),
        migrations.AlterField(
            model_name='organization',
            name='postal_code',
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(default=333, help_text='Incremental discount for payment of multiple periods (in %%).', validators=[django.core.validators.MaxValueValidator(10000)]),
        ),
        migrations.AlterField(
            model_name='plan',
            name='extra',
        ...
        migrations.AlterField(
            model_name='plan',
            name='length',
            field=models.PositiveSmallIntegerField(blank=True, help_text='Number of natural periods before a subscription to the plan ends (default to 1)', null=True),
        ),
        migrations.AlterField(
            model_name='plan',
            name='period_amount',
            field=models.PositiveIntegerField(default=0, help_text='Recurring amount per period in currency unit'),
        ),
        migrations.AlterField(
            model_name='plan',
            name='period_length',
            field=models.PositiveSmallIntegerField(default=1, help_text='Natural period length of a subscription to the plan (monthly, yearly, etc.)'),
        ),
        migrations.AlterField(
            model_name='plan',
            name='setup_amount',
            field=models.PositiveIntegerField(default=0, help_text='One-time charge amount in currency unit'),
        ),
        migrations.AlterField(
            model_name='role',
            name='extra',

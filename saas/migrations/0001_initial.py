    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.PositiveIntegerField(default=0, help_text=b'Amount in cents')),
                ('unit', models.CharField(default=b'usd', max_length=3)),
                ('description', models.TextField(null=True)),
                ('last4', models.PositiveSmallIntegerField()),
                ('exp_date', models.DateField()),
                ('processor_key', models.SlugField(unique=True)),
                ('state', models.PositiveSmallIntegerField(choices=[(3, b'disputed'), (1, b'done'), (2, b'failed'), (0, b'created')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent', models.PositiveSmallIntegerField(default=0, help_text=b'Percentage discounted', validators=[django.core.validators.MaxValueValidator(100)])),
                ('ends_at', models.DateTimeField(blank=True, null=True)),
                ('nb_attempts', models.IntegerField(blank=True, help_text=b'Number of times the coupon can be used', null=True)),
                ('extra', models.TextField(null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_bulk_buyer', models.BooleanField(default=False, help_text=b'Enable GroupBuy (<a href="/docs/#group-billing" target="_blank">what is it?</a>)')),
                ...
                ('funds_balance', models.PositiveIntegerField(default=0, help_text=b'Funds escrowed in cents')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.PositiveSmallIntegerField(choices=[(1, b'HOURLY'), (2, b'DAILY'), (3, b'WEEKLY'), (4, b'MONTHLY'), (5, b'YEARLY')], default=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_column=b'user_id', on_delete=django.db.models.deletion.CASCADE, related_name='signatures', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orig_account', models.CharField(default=b'unknown', max_length=255)),
                ('orig_amount', models.PositiveIntegerField(default=0, help_text='amount withdrawn from origin in origin units')),
                ('orig_unit', models.CharField(default=b'usd', help_text='Measure of units on origin account', max_length=3)),
                ('dest_account', models.CharField(default=b'unknown', max_length=255)),
                ('dest_amount', models.PositiveIntegerField(default=0, help_text='amount deposited into destination in destination units')),
                ('dest_unit', models.CharField(default=b'usd', help_text='Measure of units on destination account', max_length=3)),
                ('descr', models.TextField(default=b'N/A')),
        ...
        migrations.AddField(
            model_name='role',
            name='user',
            field=models.ForeignKey(db_column=b'user_id', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='invoiced',
            field=models.ForeignKey(help_text=b'transaction invoiced through this charge', on_delete=django.db.models.deletion.CASCADE, related_name='invoiced_item', to='saas.Transaction'),
        ),
        migrations.AddField(
            model_name='chargeitem',
            name='invoiced_distribute',
            field=models.ForeignKey(help_text=b'transaction recording the distribution from processor to provider.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoiced_distribute', to='saas.Transaction'),
        ),
        migrations.AddField(
            model_name='chargeitem',
            name='invoiced_fee',
            field=models.ForeignKey(help_text=b'fee transaction to process the transaction invoiced through this charge', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoiced_fee_item', to='saas.Transaction'),
        ),
        migrations.AddField(
            model_name='charge',
            name='customer',
            field=models.ForeignKey(help_text=b'organization charged', on_delete=django.db.models.deletion.CASCADE, to='saas.Organization'),
        ),
        migrations.AddField(
            model_name='charge',
            name='processor',
        ...
        migrations.AddField(
            model_name='cartitem',
            name='user',
            field=models.ForeignKey(db_column=b'user_id', help_text='user who added the item to the cart. ``None`` means the item could be claimed.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cart_items', to=settings.AUTH_USER_MODEL),
        ),

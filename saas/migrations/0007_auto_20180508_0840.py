# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2018-05-08 13:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(default=b'America/Chicago', max_length=100),
        ),
        ...
        migrations.AlterField(
            model_name='charge',
            name='state',
            field=models.PositiveSmallIntegerField(choices=[(3, 'disputed'), (1, 'done'), (0, 'created'), (2, 'failed')], default=0),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='signature',
            name='user',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.PROTECT, related_name='signatures', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
